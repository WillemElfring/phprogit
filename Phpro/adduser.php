...
<form action="adduser_submit.php" method="post">
    <fieldset>
        ...
        <p>
            <label for='phpro_password''>IBAN nummer</label>
            <input type='text' id='phpro_iban' name='phpro_iban' value='' minlength='18' maxlength='18' />
        </p>
        <p>
            <input type="hidden" name="form_token"
                   value="<?php echo $form_token; ?>" />
            <input type="submit" value="&rarr; Login" /><br>
            <a href="login.html">heb je al een account klik hier!</a>
        </p>
    </fieldset>
</form>
</body>
