...
if(!isset( $_POST['phpro_username'], $_POST['phpro_password'], $_POST['form_token'], $_POST['phpro_iban']))
{
  ...
  //  $mysql_dbname = 'phpro_auth';
    ...
    try
    {
	   ...
	   /*** $message = a message saying we have connected ***/
        ...
        /*** prepare the insert ***/
        $stmt = $dbh->prepare("INSERT INTO phpro_users (phpro_username, phpro_password, phpro_iban ) VALUES (:phpro_username, :phpro_password, :phpro_iban)");
